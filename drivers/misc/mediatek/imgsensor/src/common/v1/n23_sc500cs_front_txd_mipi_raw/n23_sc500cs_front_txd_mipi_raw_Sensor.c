...
#include "n23_sc500cs_front_txd_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N23_SC500CS_FRONT_TXD_SENSOR_ID,
	...
	.pre = {
		...
		.startx = 0,
		.starty = 0,
		//+bug 663265 zhoumin.wt, modify, 2021/09/16, modify for tuning issue
	...
	.isp_driving_current = ISP_DRIVING_2MA,//Bug682590 liuxiangyin.wt, add, 2021/10/18, add fae code change mipi rate to fix sc500cs sensor radio-frequency interference issue.
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
 { 2592, 1944,	  0,	0, 2592, 1944, 1296, 972, 0000, 0000, 1296, 972,    0,	0, 1296, 972}, // Preview    //+bug 663265 zhoumin.wt, modify, 2021/09/16, modify for tuning issue
...
static void capture_setting(kal_uint16 currefps)
{
...
#else
	kal_uint32 default_frame_length = 2000;
	if (currefps == 300) {
		LOG_INF("capture_setting fps = 300\n");
	}else{
		LOG_INF("capture_setting fps not 300\n");
	}
	default_frame_length = default_frame_length*300/currefps;
	write_cmos_sensor8(0x0103,0x01); // stream off
	write_cmos_sensor8(0x0100,0x00);
	write_cmos_sensor8(0x36e9,0x80);
	write_cmos_sensor8(0x36f9,0x80);
	...
	write_cmos_sensor8(0x320c,0x06);
	write_cmos_sensor8(0x320d,0x40);
	write_cmos_sensor8(0x320e,default_frame_length >> 8);
	write_cmos_sensor8(0x320f,default_frame_length & 0xff);
	write_cmos_sensor8(0x3221,0x66);//mirror and flip
	write_cmos_sensor8(0x3249,0x0f);
	write_cmos_sensor8(0x3253,0x06);
	write_cmos_sensor8(0x3271,0x13);
...
static struct stCAM_CAL_DATAINFO_STRUCT n23_sc500cs_front_txd_eeprom_data ={
	.sensorID= N23_SC500CS_FRONT_TXD_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0778, //bug 682590, zhanghao2.wt, Modify, 2021/11/16, fix otp preload mode fail.
	.sensorVendorid = 0x19050100,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT n23_sc500cs_front_txd_checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+Bug 682590, zhoumin.wt, add, 2021.08.24, bring-up OTP for front and micro camera
				size = imgSensorReadEepromData(&n23_sc500cs_front_txd_eeprom_data,n23_sc500cs_front_txd_checksum);
				if(size != n23_sc500cs_front_txd_eeprom_data.dataLength || (n23_sc500cs_front_txd_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					pr_err("get eeprom data failed\n");
					if(n23_sc500cs_front_txd_eeprom_data.dataBuffer != NULL) {
						kfree(n23_sc500cs_front_txd_eeprom_data.dataBuffer);
						n23_sc500cs_front_txd_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_debug("get eeprom data success\n");
					imgSensorSetEepromData(&n23_sc500cs_front_txd_eeprom_data);
				}
				//+Bug 682590, zhoumin.wt, add, 2021.08.24, bring-up OTP for front and micro camera
...
UINT32 N23_SC500CS_FRONT_TXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	TMO_SUB_LY_SC500CS_MIPI_RAW_SensorInit	*/
